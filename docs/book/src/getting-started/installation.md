...
go run github.com/muhfaris/gherkio@v0.1.0-alpha.8 init

# Execute tests
go run github.com/muhfaris/gherkio@v0.1.0-alpha.8 run .gherkio/tests/example/login.yaml
```
...
```
gherkio version v0.1.0-alpha.8 (commit: 45edd86, built: 2026-05-31, go1.26)
```
